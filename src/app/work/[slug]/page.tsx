          ...
          <div className="lg:col-span-8">
            ...
            <RevealOnScroll direction="up">
              ...
              <div className="prose prose-lg prose-invert max-w-none text-gray-400 font-light leading-relaxed mb-24">
                <p>
                  Sajal Singh approached this project by deeply understanding the target audience and market positioning. We utilized a mix of motion graphics, typography, and live-action elements to create a cohesive and impactful narrative.
                </p>
                <p>
