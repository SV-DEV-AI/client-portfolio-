      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="mb-20 text-center">
          <RevealOnScroll direction="up">
            <SectionLabel>The Director</SectionLabel>
          </RevealOnScroll>
          <RevealOnScroll direction="up" delay={0.1}>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-[1.1] tracking-tight max-w-2xl mx-auto">
